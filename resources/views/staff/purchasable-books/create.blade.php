...
@section('title', 'Thêm sách sản phẩm - Nhân viên')
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('staff.purchasable-books.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select name="dinh_dang" class="form-control @error('dinh_dang') is-invalid @enderror" required>
                                                ...
                                                <option value="Sách giấy" {{ old('dinh_dang') == 'Sách giấy' ? 'selected' : '' }}>Sách giấy</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="so_luong_ton" class="form-control @error('so_luong_ton') is-invalid @enderror" 
                                                   value="{{ old('so_luong_ton', 0) }}" min="0">
                                            @error('so_luong_ton')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
