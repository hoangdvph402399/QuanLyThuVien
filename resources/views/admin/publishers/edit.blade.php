...
@section('title', 'Chỉnh Sửa Nhà Xuất Bản - Admin')
...
<div class="container-fluid">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Chỉnh sửa: {{ $publisher->ten_nha_xuat_ban }}</li>
        </ol>
    </nav>
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <h2><i class="fas fa-edit"></i> Chỉnh sửa nhà xuất bản</h2>
                <div class="d-flex gap-2">
                    <a href="{{ route('admin.publishers.show', $publisher->id) }}" class="btn btn-info">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.publishers.update', $publisher->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="ten_nha_xuat_ban" class="form-label">Tên nhà xuất bản <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control @error('ten_nha_xuat_ban') is-invalid @enderror" 
                                           id="ten_nha_xuat_ban" name="ten_nha_xuat_ban" 
                                           value="{{ old('ten_nha_xuat_ban', $publisher->ten_nha_xuat_ban) }}" required>
                                    @error('ten_nha_xuat_ban')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('trang_thai') is-invalid @enderror" 
                                        ...
                                        <option value="active" {{ old('trang_thai', $publisher->trang_thai) == 'active' ? 'selected' : '' }}>Hoạt động</option>
                                        <option value="inactive" {{ old('trang_thai', $publisher->trang_thai) == 'inactive' ? 'selected' : '' }}>Tạm dừng</option>
                                    </select>
                                    @error('trang_thai')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('dia_chi') is-invalid @enderror" 
                                              id="dia_chi" name="dia_chi" rows="3">{{ old('dia_chi', $publisher->dia_chi) }}</textarea>
                                    @error('dia_chi')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('mo_ta') is-invalid @enderror" 
                                              id="mo_ta" name="mo_ta" rows="3">{{ old('mo_ta', $publisher->mo_ta) }}</textarea>
                                    @error('mo_ta')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('so_dien_thoai') is-invalid @enderror" 
                                           ...
                                           value="{{ old('so_dien_thoai', $publisher->so_dien_thoai) }}">
                                    @error('so_dien_thoai')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control @error('ngay_thanh_lap') is-invalid @enderror" 
                                           ...
                                           value="{{ old('ngay_thanh_lap', $publisher->ngay_thanh_lap ? $publisher->ngay_thanh_lap->format('Y-m-d') : '') }}">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row text-center">
                        ...
                        <div class="col-6">
                            <h4 class="text-success">{{ $publisher->formatted_founded_date }}</h4>
